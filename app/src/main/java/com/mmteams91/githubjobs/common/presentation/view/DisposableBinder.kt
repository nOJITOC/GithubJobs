...
class DisposableBinder private constructor(lifecycle: Lifecycle) : IDisposableBinder, LifecycleObserver {
    ...
    companion object {
        fun on(lifecycle: Lifecycle) = DisposableBinder(lifecycle)
    }
}